...
(defun my-python-mode-hook ()
  (define-key python-mode-map [(f10)] 'eval-python-buffer))
  ;; (define-key python-mode-map [(f4)] 'python-db))
...
;;нормальное отображение длинных строк
...
(add-to-list 'load-path "~/.emacs.d/Settings/csharp-mode")
;;(require 'csharp-mode)
;;(require 'csharp-mode-tests)
